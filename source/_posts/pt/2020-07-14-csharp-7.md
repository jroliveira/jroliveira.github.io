...
internal class User
{
    ...
    public User UpdateUser(uint id, string name = default(string)) => new User(name ?? this.name)
    {
        id = id,
    };
}
...
internal class User
{
    ...
    public User UpdateUser(uint id, string name = default) => new User(name ?? this.name)
    {
        id = id,
    };
}
...
##### Argumentos nomeados não finais [&uarr;](#Conteudo)
